...
void MyDialog::OnBnClickedShowEvents1()
{
	...
	for (Event event : events) {
		...
		pListBox->AddString(cDate + " " + cEventName + " " + cEventDesc + "with next contacts: \n");
